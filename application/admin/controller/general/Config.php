...
class Config extends Backend
{
    ...
    protected $filterGroup = ['basic'];
    protected $filterField = ['name','admin_pass'];
    ...
    public function index()
    {
        ...
        foreach ($groupList as $k => $v) {
            if(!empty($this->filterGroup)){
                if(!in_array($k,$this->filterGroup)) continue;
            }
            $siteList[$k]['name'] = $k;
            $siteList[$k]['title'] = $v;
            $siteList[$k]['list'] = [];
        ...
        foreach ($this->model->all() as $k => $v) {
            ...
            //TODO::过滤不需要的设置
            if(!empty($this->filterGroup) && !empty($this->filterField)){
                if(!in_array($v['group'],$this->filterGroup) || !in_array($v['name'],$this->filterField)) continue;
            }
